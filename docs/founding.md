...
> tracks (the STEERCO split-track record of 2026-07-12, control plane). Where
...
2026-07-10 (control plane). Survey inputs (consumed, not re-audited): the
TinyMUSE intake survey + register (control plane; both blockers #243/#244
